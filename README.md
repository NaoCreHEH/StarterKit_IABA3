...
## Format 3 sprints sur 8 semaines (48h)
...
- **Templates** :
  - Journal IA individuel
  - ADR (Architecture Decision Record)
  - prompts.md pour versionner les prompts
...
├── journaux_ia/
│   ├── journal_etudiant1.md       # Template à renommer
│   └── journal_etudiant2.md
├── prompts/
│   └── prompts.md                 # Versionnage des prompts utilisés
├── tests/
│   ├── conftest.py
│   └── test_chat.py
